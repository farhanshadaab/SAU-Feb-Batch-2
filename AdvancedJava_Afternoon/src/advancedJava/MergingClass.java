...
public class MergingClass {
    ...
    public static void main(String[] args) {
        try {
            ...
            File license1_doc1 = new File("C:\\Users\\MD SHADAAB FARHAN\\eclipse-workspace\\AdvancedJava_Afternoon\\test1.xml");
            File license2_doc2 = new File("C:\\Users\\MD SHADAAB FARHAN\\eclipse-workspace\\AdvancedJava_Afternoon\\test2.xml");
                        ...
                        for (int k = 0; k < license_list1.getLength(); k++) {
                            ...
                            for (int l = 0; l < license_list2.getLength(); l++) {
                                ...
                                if (license_element1.getAttribute("State_Code")
                                    ...
                                    upload(merged_doc, "C:\\Users\\MD SHADAAB FARHAN\\eclipse-workspace\\AdvancedJava_Afternoon\\merge.xml");
